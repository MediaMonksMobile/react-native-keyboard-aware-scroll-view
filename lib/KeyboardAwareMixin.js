...
const KeyboardAwareMixin = {
  ...
  resetKeyboardSpace: function () {
    ...
    if (this.props.enableResetScrollToCoords === false) {
      ...
      this.scrollToPosition(0, Math.max(Math.min(this.position.y, this.end), 0), true)
    }
  },
  ...
  handleOnScroll: function (e: SyntheticEvent & {nativeEvent: {contentOffset: number}}) {
    this.end = e.nativeEvent.contentSize.height - e.nativeEvent.layoutMeasurement.height;
